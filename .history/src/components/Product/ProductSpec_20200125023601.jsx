        ...
        if (data !== undefined) {
            return (
                <div className='specs-container'>
                    <div className="specs-container-head" onClick={this.handleClickOpeningSpecsList}>
                        <h4>Spec</h4>
                        <h4>Value</h4>
                    </div>
                    <div className="line"/>
                    {isOpened === true ? Object.entries(data).map(([nameSpec, valueSpec]) => {
                    ...
                    <div className="specs-notation" onClick={this.handleClickOpeningSpecsList}>
